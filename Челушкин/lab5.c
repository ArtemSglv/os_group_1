/*
gcc -Wall lab5.c `pkg-config fuse3 --cflags --libs` -o l5
тестовая команда rmdir реализована для foo и bar. 
команда из каталога rmdir foo/bar
*/
...
int main(int argc, char *argv[])
{
	...
	readme.contents = strdup("Student Челушкин Александр, 16120053\n");
